...
func main() {
	...
	err := generate(tableName, sourceTypeName, structType, sourceTypePackage)
	if err != nil {
		failErr(err)
	}
}
...
func generate(tableName string, sourceTypeName string, structType *types.Struct, sourceTypePackage string) error {
